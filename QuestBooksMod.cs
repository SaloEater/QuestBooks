...
namespace QuestBooks
{
    public class QuestBooksMod : Mod
    {
        ...
        public static void CompleteQuest<TQuest>() where TQuest : Quest { if (QuestManager.QuestsActive) CompleteQuest(GetQuest<TQuest>()); }
        public static void CompleteQuest(string questName) { if (QuestManager.QuestsActive) CompleteQuest(GetQuest(questName)); }
        public static void CompleteQuest(Quest quest) => QuestManager.CompleteQuest(quest);

        public static void MarkComplete<TQuest>() where TQuest : Quest { if (QuestManager.QuestsActive) MarkComplete(GetQuest<TQuest>()); }
        public static void MarkComplete(string questName) { if (QuestManager.QuestsActive) MarkComplete(GetQuest(questName)); }
        public static void MarkComplete(Quest quest) => QuestManager.MarkComplete(quest);

        public static void MarkIncomplete<TQuest>() where TQuest : Quest { if (QuestManager.QuestsActive) MarkIncomplete(GetQuest<TQuest>()); }
        public static void MarkIncomplete(string questName) { if (QuestManager.QuestsActive) MarkIncomplete(GetQuest(questName)); }
